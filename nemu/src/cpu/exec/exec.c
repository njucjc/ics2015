...
/* 0x81 */
make_group(group1_v,
	add_i2rm_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_b, 
...
/* 0x70 */	jo_si_b, jno_si_b, jnae_si_b, jae_si_b,
...
/* 0x8c */	inv, lea, mov_rm2sr_v, inv,
/* 0x90 */	nop, inv, inv, inv,
/* 0x94 */	inv, inv, inv, inv,
/* 0x98 */	cwtl, cvtv_v, inv, inv,
...
/* 0xc0 */	group2_i_b, group2_i_v, ret_imm_v,ret_near_v,
...
/* 0xe8 */	call_rel_v, jmp_si_v, ljmp_v, jmp_si_b,
/* 0xec */	in_b, in_v, out_b, out_v,
/* 0xf0 */	inv, inv, inv, rep,
/* 0xf4 */	hlt_b, inv, group3_b, group3_v,
/* 0xf8 */	inv, stc_b, cli_b, sti_b,
/* 0xfc */	cld_b, std_b, group4, group5
};
...
/* 0x40 */	cmovo_rm2r_v, cmovno_rm2r_v, cmovae_rm2r_v, cmovnb_rm2r_v, 
/* 0x44 */	cmove_rm2r_v, cmovne_rm2r_v, cmovbe_rm2r_v, cmova_rm2r_v,
/* 0x48 */	cmovs_rm2r_v, cmovns_rm2r_v, cmovp_rm2r_v, cmovnp_rm2r_v, 
/* 0x4c */	cmovnge_rm2r_v, cmovge_rm2r_v, cmovng_rm2r_v, cmovg_rm2r_v, 
...
/* 0x80 */	jo_si_v, jno_si_v, jnae_si_v, jae_si_v,
